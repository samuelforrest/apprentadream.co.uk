...
export function Step3SocialAccounts({
  ...
  onUpdate,
  onErrorClear,
}: Step3SocialAccountsProps) {
  return (
    <div className="space-y-4 mb-4">
      <div className="text-left mb-10 md:mb-12">
        <p className="text-sm text-black mb-2">
          This section is optional. When we launch our online platform, these will be added to your
          profile. We highly recommend you add them.
        </p>
      </div>

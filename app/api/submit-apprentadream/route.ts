...
export async function POST(request: NextRequest) {
  try {
    ...
    const { error } = await supabase.from("apprentadream_submissions").insert([
      {
        ...
        apprenticeship_level: data.apprenticeshipLevel,
        ...
        applying_university: data.applyingUniversity,
